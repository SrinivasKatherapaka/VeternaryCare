...
VALUES
('t1111111-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', 'gemini-2.5-pro', 'SURGICAL_CONSENT', 310, 0.985, 412, FALSE, NULL, 0.03, NOW() - INTERVAL '1 day'),
('t2222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'gemini-2.5-pro', 'CONTROLLED_DRUG_LOG', 285, 0.580, 480, TRUE, 'Missing witness co-signature flagged by AI validated by Officer', 0.04, NOW() - INTERVAL '5 hours'),
('t3333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'gemini-2.5-pro', 'VACCINATION_CERTIFICATE', 260, 0.960, 395, FALSE, NULL, 0.02, NOW() - INTERVAL '3 days'),
('t4444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', 'gemini-2.5-pro', 'ITEMIZED_INVOICE', 340, 0.720, 520, TRUE, 'Discrepancy detection between invoice line items and safe log', 0.05, NOW() - INTERVAL '2 days'),
('t5555555-5555-5555-5555-555555555555', '11111111-1111-1111-1111-111111111111', 'gemini-2.5-pro', 'DIAGNOSTIC_LAB_REPORT', 290, 0.940, 460, FALSE, NULL, 0.03, NOW() - INTERVAL '4 days');
